...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _dynamic_message_dynamic_message_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./dynamic-message/dynamic-message.component */
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_4__["DashboardComponent"], _dynamic_message_dynamic_message_component__WEBPACK_IMPORTED_MODULE_6__["DynamicMessageComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _dynamic_message_dynamic_message_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../dynamic-message/dynamic-message.component */
    "./src/app/dynamic-message/dynamic-message.component.ts");
    /* harmony import */


    var _models_automata__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../models/automata */
    "./src/app/models/automata.ts");
    /* harmony import */


    var _svg_renderer_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    function DashboardComponent_table_6_th_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DashboardComponent_table_6_tr_5_span_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DashboardComponent_table_6_tr_5_td_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DashboardComponent_table_6_tr_5_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DashboardComponent_table_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var DashboardComponent = /*#__PURE__*/function () {
      function DashboardComponent(svgRendererService, resolver, sanitizer) {
      ...
      _createClass(DashboardComponent, [{
        key: "generateArray",
        value: function generateArray(count) {
          return _toConsumableArray(Array(count).keys());
        }
      }, {
        key: "isAcceptState",
        value: function isAcceptState(state) {
          return this.automata.dfa.acceptStates.indexOf(state) >= 0;
        }
      }, {
        key: "getNextStateFor",
        value: function getNextStateFor(state, symbol) {
          if (this.automata.transitionStateDiagram.transitionStates[state] && this.automata.transitionStateDiagram.transitionStates[state].has(symbol)) {
        ...
        key: "createComponent",
        value: function createComponent(message) {
          this.entry.clear();
          var factory = this.resolver.resolveComponentFactory(_dynamic_message_dynamic_message_component__WEBPACK_IMPORTED_MODULE_1__["DynamicMessageComponent"]);
        ...
        key: "recognizedByLanguage",
        value: function recognizedByLanguage() {
          if (this.automata && this.automata.dfa) {
            return this.automata.dfa.match(this.text);
          }
        }
      }, {
        key: "regexInputChanged",
        value: function regexInputChanged() {
        ...
        value: function createSvg() {
          switch (this.selected) {
            case 'dfa':
              return this.createSvgFrom(this.automata.dfaDotScript);

            case 'nfa':
              return this.createSvgFrom(this.automata.nfaDotScript);
          }
        }
      }, {
        key: "createSvgFrom",
        value: function createSvgFrom(dotScript) {
          var _this = this;

          this.svgRendererService.render(dotScript).then(function (svg) {
            _this.createComponent(_this.sanitizer.bypassSecurityTrustHtml(svg.substring(_this.STARTING_INDEX, svg.length)));
          })["catch"](function (error) {});
        }
      }, {
        key: "setNfa",
        value: function setNfa() {
          this.selected = 'nfa';
          this.createSvgFrom(this.automata.nfaDotScript);
        }
      }, {
        key: "setDfa",
        value: function setDfa() {
          this.selected = 'dfa';
    ...
    DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 26,
      vars: 9,
      consts: [["id", "component-wrapper"], ["id", "toolbar"], ["id", "main"], ["id", "deck-1"], [4, "ngIf"], ["id", "deck-2"], ["id", "regexp-checker"], ["for", "regex"], ["type", "text", "name", "regex", "id", "regex", 3, "ngModel", "ngModelChange"], ["for", "string-parse"], ["id", "string-parse", 1, "isRecognized", 3, "ngModel", "ngModelChange"], ["class", "recognized", 4, "ngIf"], ["class", "not-recognized", 4, "ngIf"], ["id", "automata-display-panel"], ["id", "automata-toolbar"], [3, "click"], ["id", "automata-container"], ["messageContainer", ""], [4, "ngFor", "ngForOf"], [3, "ngClass"], [3, "innerHTML", 4, "ngFor", "ngForOf"], [3, "innerHTML"], [1, "recognized"], [1, "not-recognized"]],
      template: function DashboardComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DashboardComponent_Template_input_ngModelChange_11_listener($event) {
            return ctx.regex = $event;
          })("ngModelChange", function DashboardComponent_Template_input_ngModelChange_11_listener() {
            return ctx.regexInputChanged();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DashboardComponent_Template_textarea_ngModelChange_14_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_Template_a_click_19_listener() {
            return ctx.setNfa();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DashboardComponent, [{
        ...
        return [{
          type: _svg_renderer_service__WEBPACK_IMPORTED_MODULE_3__["SvgRendererService"]
        }, {
  ...
  /***/
  function srcAppDynamicMessageDynamicMessageComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DynamicMessageComponent", function () {
      return DynamicMessageComponent;
    });
    /* harmony import */
    ...
    var DynamicMessageComponent = /*#__PURE__*/function () {
      function DynamicMessageComponent() {
        _classCallCheck(this, DynamicMessageComponent);
      }

      _createClass(DynamicMessageComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    DynamicMessageComponent.ɵfac = function DynamicMessageComponent_Factory(t) {
      return new (t || DynamicMessageComponent)();
    };

    DynamicMessageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: DynamicMessageComponent,
      selectors: [["app-dynamic-message"]],
      decls: 1,
      vars: 1,
      consts: [[3, "innerHTML"]],
      template: function DynamicMessageComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DynamicMessageComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModelsAutomataTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Automata", function () {
      return Automata;
    });
    /* harmony import */


    var automata_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! automata.js */
    "./node_modules/automata.js/index.js");
    /* harmony import */


    var automata_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(automata_js__WEBPACK_IMPORTED_MODULE_0__);
    /* harmony import */


    var _transition_state_diagram__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./transition-state-diagram */
    "./src/app/models/transition-state-diagram.ts");

    var Automata = function Automata(regex) {
  ...
  /***/
  function srcAppModelsTransitionStateDiagramTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TransitionStateDiagram", function () {
      return TransitionStateDiagram;
    });

    var TransitionStateDiagram = function TransitionStateDiagram(dfa) {
      _classCallCheck(this, TransitionStateDiagram);
      ...
      for (var state in dfa.transitions) {
        ...
        for (var nextState in dfa.transitions[state]) {
          var symbol = dfa.transitions[state][nextState];
  ...
  /***/
  function srcAppSvgRendererServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SvgRendererService", function () {
    ...
    var viz_js_full_render_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! viz.js/full.render.js */
    "./node_modules/viz.js/full.render.js");
    /* harmony import */


    var viz_js_full_render_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(viz_js_full_render_js__WEBPACK_IMPORTED_MODULE_1__);
    /* harmony import */


    var viz_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! viz.js */
    "./node_modules/viz.js/viz.es.js");

    var SvgRendererService = /*#__PURE__*/function () {
      function SvgRendererService() {
        _classCallCheck(this, SvgRendererService);
      }

      _createClass(SvgRendererService, [{
        key: "render",
        value: function render(dotScript) {
          return new viz_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
            Module: viz_js_full_render_js__WEBPACK_IMPORTED_MODULE_1__["Module"],
            render: viz_js_full_render_js__WEBPACK_IMPORTED_MODULE_1__["render"]
          }).renderString(dotScript); // .then(result => {
          //   return result;
          // })
          // .catch(error => {
    ...
    SvgRendererService.ɵfac = function SvgRendererService_Factory(t) {
      return new (t || SvgRendererService)();
    };

    SvgRendererService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: SvgRendererService,
      factory: SvgRendererService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SvgRendererService, [{
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\anish\projects\state-diagram-generator\src\main.ts */
    "./src/main.ts");
    /***/
  },
